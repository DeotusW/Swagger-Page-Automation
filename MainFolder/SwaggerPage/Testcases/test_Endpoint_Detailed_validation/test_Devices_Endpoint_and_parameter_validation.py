...
class TestDevicesEndpointValidation(Baseclass):
    REQUEST = "POST"
    GET_BUTTON_COLOR = "rgb(73, 204, 144)"
    ...
    def test_devices_endpoint_validation(self, ds, BrowserOpen):
        ...
        BaseEndpointValidation.validation(self.REQUEST,ds["endpoint"],self.GET_BUTTON_COLOR,Element_POST_devices_text,Element_devices,Element_POST_devices_BGColor)
